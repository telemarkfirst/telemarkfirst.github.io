...
**Task:** Control a Servo named `"grabber"`. If Button A is pressed, set the position to `1.0` (closed). If Button B is pressed, set it to `0.0` (open). Otherwise, the servo should stay at `0.5` (ready position).
