...
**Task:** Your team is using a Distance Sensor to prevent the robot from hitting walls. If the distance reading is less than `10.0` cm, the motor power should be set to `0.0` immediately.
