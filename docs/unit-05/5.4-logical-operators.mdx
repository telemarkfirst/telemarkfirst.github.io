...
**Task:** Your robot should only activate the drivetrain if the Start button is **NOT** pressed **AND** the Left Trigger is held down more than halfway. (This is a complex safety check.)
