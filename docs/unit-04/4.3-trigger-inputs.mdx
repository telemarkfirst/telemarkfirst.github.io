...
**Task:** The drive team wants to use the Left Trigger to control the robot's "Slow Mode." Create a variable that stores the trigger value and use it to report the current "Speed Limit" to the drivers.
