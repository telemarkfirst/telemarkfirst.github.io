...
**Task:** You need to create a custom scaling method for the drive team. Implement a method that **cubes** the input (`input * input * input`) instead of squaring it to provide an even "softer" feel at low speeds. (Note: Cubing naturally preserves the sign!)
