...
**Task:** Create a "Precision Mode." If the driver holds the left bumper, the motor power should be exactly half of the joystick input. Use variables for `input`, `scaleFactor`, and `finalPower`.
